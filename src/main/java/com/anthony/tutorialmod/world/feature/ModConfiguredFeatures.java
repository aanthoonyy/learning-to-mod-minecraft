package com.anthony.tutorialmod.world.feature;
...
public class ModConfiguredFeatures {
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> EBONY_TREE =
            FeatureUtils.register("ebony", Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder( // how we build a tree
                    BlockStateProvider.simple(ModBlocks.EBONY_LOG.get()), //tree trunk
                    new StraightTrunkPlacer(5, 6, 3), // places trunk straight up,
                    BlockStateProvider.simple(ModBlocks.EBONY_LEAVES.get()), // provides the leaves
                    new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 4), // way way the leaves are placed
                    new TwoLayersFeatureSize(1, 0, 2)).build());
    // how we build a tree end
